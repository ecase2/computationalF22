...
# Produce Figure 1
function graphExit(par::Params, pol_func1, pol_func2, pol_func3; plotname::String)
    @unpack Ns = par
    ...
    pname = string(plotname, ".png")

    savefig(joinpath(figpath, pname))
end

# Produce Figure 1
function graphExit_no2(par::Params, pol_func1, pol_func2; plotname::String)
    @unpack Ns = par
